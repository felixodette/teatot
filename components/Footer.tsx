...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-border)] bg-[var(--color-white)]">
      <div className="mx-auto grid max-w-[var(--container-max)] gap-12 px-6 py-16 tablet:grid-cols-2 tablet:px-8 desktop:grid-cols-4 desktop:px-10">
        {/* Brand */}
          ...
          <div className="flex gap-3">
            {footerLinks.social.map((s) => (
              <a
                ...
                className="text-[var(--color-text-subtle)] transition-opacity hover:opacity-60"
        ...
        <div className="flex flex-col gap-3">
          <span className="text-xs font-medium uppercase tracking-widest text-[var(--color-text-subtle)]">
            Navigate
          </span>
          {footerLinks.navigate.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-sm text-[var(--color-text-primary)] transition-opacity hover:opacity-60"
            >
              {link.label}
            </Link>
          ))}
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-[var(--color-text-primary)]">{contact.address}</p>
          <a
